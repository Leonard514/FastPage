...
layout: default
badges: false
permalink: /notebooks/troubleshooting
categories: [Comp Sci, jupyter ]
nb_path: _notebooks/2022-10-03-AP-error_test-corrected.ipynb
layout: notebook
---
...
#################################################
# file to edit: _notebooks/2022-10-03-AP-error_test-corrected.ipynb
-->
...
<span class="k">while</span> <span class="n">i</span> <span class="o">&lt;</span> <span class="mi">26</span><span class="p">:</span>
    <span class="k">if</span> <span class="n">alphabetList</span><span class="p">[</span><span class="n">i</span><span class="p">]</span> <span class="o">==</span> <span class="n">letter</span><span class="p">:</span>
        <span class="nb">print</span><span class="p">(</span><span class="s2">&quot;The letter &quot;</span> <span class="o">+</span> <span class="n">letter</span> <span class="o">+</span> <span class="s2">&quot; is letter &quot;</span> <span class="o">+</span> <span class="nb">str</span><span class="p">(</span><span class="n">i</span><span class="o">+</span><span class="mi">1</span><span class="p">)</span> <span class="o">+</span> <span class="s2">&quot; in the alphabet&quot;</span><span class="p">)</span>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>The letter f is letter 6 in the alphabet
</pre>
</div>
</div>
...
<span class="k">for</span> <span class="n">i</span> <span class="ow">in</span> <span class="n">alphabetList</span><span class="p">:</span>
    <span class="k">if</span> <span class="n">i</span> <span class="o">==</span> <span class="n">letter</span><span class="p">:</span>
        <span class="nb">print</span><span class="p">(</span><span class="s2">&quot;The letter &quot;</span> <span class="o">+</span> <span class="n">letter</span> <span class="o">+</span> <span class="s2">&quot; is letter &quot;</span> <span class="o">+</span> <span class="nb">str</span><span class="p">(</span><span class="n">count</span><span class="p">)</span> <span class="o">+</span> <span class="s2">&quot; in the alphabet&quot;</span><span class="p">)</span>
    <span class="n">count</span> <span class="o">+=</span> <span class="mi">1</span>
</pre></div>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>The letter y is letter 25 in the alphabet
</pre>
</div>
</div>
...
<span class="k">for</span> <span class="n">i</span> <span class="ow">in</span> <span class="n">newNumbers</span><span class="p">:</span>
    <span class="k">if</span> <span class="n">newNumbers</span><span class="p">[</span><span class="n">i</span><span class="p">]</span> <span class="o">==</span> <span class="mi">0</span><span class="p">:</span>
        <span class="n">newNumbers</span><span class="o">.</span><span class="n">remove</span><span class="p">(</span><span class="n">newNumbers</span><span class="p">[</span><span class="n">i</span><span class="p">])</span>
...
Cell <span class="ansi-green-fg">In [14], line 16</span>
<span class="ansi-green-intense-fg ansi-bold">     13</span>         newNumbers<span style="color: rgb(98,98,98)">.</span>append(numbers[i])
<span class="ansi-green-intense-fg ansi-bold">     15</span> <span class="ansi-bold" style="color: rgb(0,135,0)">for</span> i <span class="ansi-bold" style="color: rgb(175,0,255)">in</span> newNumbers:
<span class="ansi-green-fg">---&gt; 16</span>     <span class="ansi-bold" style="color: rgb(0,135,0)">if</span> newNumbers[i] <span style="color: rgb(98,98,98)">==</span> <span style="color: rgb(98,98,98)">0</span>:
<span class="ansi-green-intense-fg ansi-bold">     17</span>         newNumbers<span style="color: rgb(98,98,98)">.</span>remove(newNumbers[i])
<span class="ansi-green-intense-fg ansi-bold">     19</span> <span style="color: rgb(0,135,0)">print</span>(newNumbers)
...
<div class="inner_cell">
    <div class="input_area">
<div class=" highlight hl-ipython3"><pre><span></span><span class="kn">from</span> <span class="nn">tkinter.messagebox</span> <span class="kn">import</span> <span class="n">YES</span>
...
<span class="n">menu</span> <span class="o">=</span>  <span class="p">{</span><span class="s2">&quot;burger&quot;</span><span class="p">:</span> <span class="mf">3.99</span><span class="p">,</span>
         ...
         <span class="s2">&quot;combo&quot;</span><span class="p">:</span> <span class="mf">4.99</span><span class="p">,</span>
         <span class="s2">&quot;onion rings&quot;</span><span class="p">:</span> <span class="mf">2.99</span><span class="p">,</span>
         <span class="s2">&quot;salad&quot;</span><span class="p">:</span> <span class="mf">5.99</span><span class="p">,</span>
         <span class="s2">&quot;chicken nuggets&quot;</span><span class="p">:</span> <span class="mf">3.25</span><span class="p">}</span>
...
<span class="k">def</span> <span class="nf">inputcollect</span><span class="p">():</span>
    ...
    <span class="n">total</span> <span class="o">=</span> <span class="n">total</span> <span class="o">+</span> <span class="n">menu</span><span class="p">[</span><span class="nb">str</span><span class="p">(</span><span class="n">item</span><span class="p">)]</span>
    <span class="n">question</span> <span class="o">=</span> <span class="nb">input</span><span class="p">(</span><span class="s2">&quot;Do you want to order anything else (yes/no)?&quot;</span><span class="p">)</span>
    <span class="k">if</span> <span class="n">question</span> <span class="o">==</span> <span class="s2">&quot;yes&quot;</span><span class="p">:</span>
        <span class="n">inputcollect</span><span class="p">()</span>
...
<span class="ansi-green-fg">----&gt; 1</span> <span class="ansi-bold" style="color: rgb(0,135,0)">from</span> <span class="ansi-bold" style="color: rgb(0,0,255)">tkinter</span><span class="ansi-bold" style="color: rgb(0,0,255)">.</span><span class="ansi-bold" style="color: rgb(0,0,255)">messagebox</span> <span class="ansi-bold" style="color: rgb(0,135,0)">import</span> YES
<span class="ansi-green-intense-fg ansi-bold">      4</span> menu <span style="color: rgb(98,98,98)">=</span>  {<span style="color: rgb(175,0,0)">&#34;</span><span style="color: rgb(175,0,0)">burger</span><span style="color: rgb(175,0,0)">&#34;</span>: <span style="color: rgb(98,98,98)">3.99</span>,
<span class="ansi-green-intense-fg ansi-bold">      5</span>          <span style="color: rgb(175,0,0)">&#34;</span><span style="color: rgb(175,0,0)">fries</span><span style="color: rgb(175,0,0)">&#34;</span>: <span style="color: rgb(98,98,98)">1.99</span>,
<span class="ansi-green-intense-fg ansi-bold">      6</span>          <span style="color: rgb(175,0,0)">&#34;</span><span style="color: rgb(175,0,0)">drink</span><span style="color: rgb(175,0,0)">&#34;</span>: <span style="color: rgb(98,98,98)">0.99</span>,
<span class="ansi-green-fg">   (...)</span>
<span class="ansi-green-intense-fg ansi-bold">      9</span>          <span style="color: rgb(175,0,0)">&#34;</span><span style="color: rgb(175,0,0)">salad</span><span style="color: rgb(175,0,0)">&#34;</span>: <span style="color: rgb(98,98,98)">5.99</span>,
<span class="ansi-green-intense-fg ansi-bold">     10</span>          <span style="color: rgb(175,0,0)">&#34;</span><span style="color: rgb(175,0,0)">chicken nuggets</span><span style="color: rgb(175,0,0)">&#34;</span>: <span style="color: rgb(98,98,98)">3.25</span>}
<span class="ansi-green-intense-fg ansi-bold">     13</span> <span style="color: rgb(95,135,135)">#shows the user the menu and prompts them to select an item</span>

<span class="ansi-red-fg">ModuleNotFoundError</span>: No module named &#39;tkinter&#39;</pre>
</div>
</div>
